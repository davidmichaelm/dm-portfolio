    ...
    return (
        <header className={styles.header}>
            ...
            <div className={styles.headerRight}>
                ...
                <p>
                    Front-end development with <strong>Vue</strong>, <strong>React</strong>, and other modern tech are the most interesting to me, but I'm also proficient with <strong>.Net Core</strong> back-ends.
                </p>
                <p>
